...
class SegmentIdTestCase(unittest.TestCase):
    ...
    def test_segment_id_numbering(self, morph_file=None):
        ...
        neuron_model = NeuronModel(param_file=os.path.join(os.path.dirname(__file__), "test_data", "data", "fake-parameters.json"),
                                   morph_path=morph_file,
                                   mech_file=os.path.join(os.path.dirname(__file__), "test_data", "data", "fake-mechanisms.json"),
                                   cell_name="fs",
