...
#define CaBuffer_columnindex 7
#define Buffer (_p + 11)
#define Buffer_columnindex 11
#define pump _p[15]
#define pump_columnindex 15
#define pumpca _p[16]
#define pumpca_columnindex 16
#define cao _p[17]
#define cao_columnindex 17
#define ica _p[18]
#define ica_columnindex 18
#define cai _p[19]
#define cai_columnindex 19
#define Dca (_p + 20)
#define Dca_columnindex 20
#define DCaBuffer (_p + 24)
#define DCaBuffer_columnindex 24
#define DBuffer (_p + 28)
#define DBuffer_columnindex 28
#define Dpump _p[32]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "area");
 	...
 	ivoc_help("help ?1 ca_ch ca_ch.mod\n");
...
static void _initlists() {
 ...
 _slist1[12] = pumpca_columnindex;  _dlist1[12] = Dpumpca_columnindex;
 _slist1[13] = pump_columnindex;  _dlist1[13] = Dpump_columnindex;
_first = 0;
}

#if NMODL_TEXT
static const char* nmodl_filename = "ca_ch.mod";
static const char* nmodl_file_text = 
