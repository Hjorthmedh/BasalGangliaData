...
#define modulation_input _p[3]
#define modulation_input_columnindex 3
#define i _p[4]
...
extern "C" {
 ...
 static double _hoc_modulator(void*);
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modulator", _hoc_modulator,
 0, 0
};
#define modulator modulator_concDA
 extern double modulator( _threadargsproto_ );
...
double modulator ( _threadargsproto_ ) {
   double _lmodulator;
 _lmodulator = modulation_input ;
   
return _lmodulator;
 }
 
static double _hoc_modulator(void* _vptr) {
 double _r;
   double* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _r =  modulator ( _p, _ppvar, _thread, _nt );
 return(_r);
}
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   i = amplitude * ( B - A ) * modulator ( _threadargs_ ) ;
   }
 _current += i;
