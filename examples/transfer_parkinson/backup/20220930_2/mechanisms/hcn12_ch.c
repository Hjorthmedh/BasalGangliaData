...
#define cac _p[8]
#define cac_columnindex 8
#define o _p[9]
#define o_columnindex 9
#define cao _p[10]
#define cao_columnindex 10
#define alpha _p[11]
#define alpha_columnindex 11
#define beta _p[12]
#define beta_columnindex 12
#define alphaa _p[13]
#define alphaa_columnindex 13
#define betaa _p[14]
#define betaa_columnindex 14
#define Dc _p[15]
#define Dc_columnindex 15
#define Dcac _p[16]
#define Dcac_columnindex 16
#define Do _p[17]
#define Do_columnindex 17
#define Dcao _p[18]
#define Dcao_columnindex 18
#define v _p[19]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modulationDA_hcn12_ch", _hoc_modulationDA,
 "rates_hcn12_ch", _hoc_rates,
 0, 0
};
#define modulationDA modulationDA_hcn12_ch
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 hcn12_ch hcn12_ch.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = gbar * ( o + cao * gca ) * modulationDA ( _threadargs_ ) ;
   i = g * ( v - ehcn ) ;
   }
 _current += i;
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = cao_columnindex;  _dlist1[0] = Dcao_columnindex;
 _slist1[1] = cac_columnindex;  _dlist1[1] = Dcac_columnindex;
...
#if NMODL_TEXT
static const char* nmodl_filename = "hcn12_ch.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
