...
#define nrn_init _nrn_init__kcnq_ch
#define _nrn_initial _nrn_initial__kcnq_ch
#define nrn_cur _nrn_cur__kcnq_ch
#define _nrn_current _nrn_current__kcnq_ch
#define nrn_jacob _nrn_jacob__kcnq_ch
#define nrn_state _nrn_state__kcnq_ch
#define _net_receive _net_receive__kcnq_ch 
#define kin kin__kcnq_ch 
#define rates rates__kcnq_ch 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kcnq_ch", _hoc_setdata,
 "rates_kcnq_ch", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define ac ac_kcnq_ch
 double ac = 9.7054;
#define ah ah_kcnq_ch
 double ah = -43.367;
#define a0 a0_kcnq_ch
 double a0 = 0.018;
#define bc bc_kcnq_ch
 double bc = -9.7054;
#define bh bh_kcnq_ch
 double bh = -43.367;
#define b0 b0_kcnq_ch
 double b0 = 0.01;
#define q10v q10v_kcnq_ch
 double q10v = 3;
 ...
 "a0_kcnq_ch", &a0_kcnq_ch,
 "b0_kcnq_ch", &b0_kcnq_ch,
 "ah_kcnq_ch", &ah_kcnq_ch,
 "bh_kcnq_ch", &bh_kcnq_ch,
 "ac_kcnq_ch", &ac_kcnq_ch,
 "bc_kcnq_ch", &bc_kcnq_ch,
 "q10v_kcnq_ch", &q10v_kcnq_ch,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kcnq_ch kcnq_ch.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KCNQ/M current from striatal medium spiny neurons, used for ch. interneuron.";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lqv = pow( q10v , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   alpha = a0 * _lqv / ( 1.0 + exp ( - ( _lv - ah ) / ac ) ) ;
   beta = b0 * _lqv / ( 1.0 + exp ( - ( _lv - bh ) / bc ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "kcnq_ch.mod";
static const char* nmodl_file_text = 
