...
#define nrn_init _nrn_init__cadyn_ms
#define _nrn_initial _nrn_initial__cadyn_ms
#define nrn_cur _nrn_cur__cadyn_ms
#define _nrn_current _nrn_current__cadyn_ms
#define nrn_jacob _nrn_jacob__cadyn_ms
#define nrn_state _nrn_state__cadyn_ms
#define _net_receive _net_receive__cadyn_ms 
#define state state__cadyn_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cadyn_ms", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define kd kd_cadyn_ms
 double kd = 0.0001;
#define kt kt_cadyn_ms
 double kt = 0.0001;
 ...
 "kt_cadyn_ms", &kt_cadyn_ms,
 "kd_cadyn_ms", &kd_cadyn_ms,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadyn_ms /home/HDD-drive/Repos/Alex_model_repo/models/optim/HBP-2022Q2/str-dspn-e150602_c1_D1-mWT-0728MSN01-v20220620/mechanisms/cadyn_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/HDD-drive/Repos/Alex_model_repo/models/optim/HBP-2022Q2/str-dspn-e150602_c1_D1-mWT-0728MSN01-v20220620/mechanisms/cadyn_ms.mod";
static const char* nmodl_file_text = 
