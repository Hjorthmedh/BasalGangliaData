...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modulationACh_cal12_ms", _hoc_modulationACh,
 "modulationDA_cal12_ms", _hoc_modulationDA,
 "rates_cal12_ms", _hoc_rates,
 0, 0
};
#define efun efun_cal12_ms
#define ghk ghk_cal12_ms
#define modulationACh modulationACh_cal12_ms
#define modulationDA modulationDA_cal12_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal12_ms /home/HDD-drive/Repos/Alex_model_repo/models/optim/HBP-2022Q2/str-dspn-e150602_c1_D1-mWT-0728MSN01-v20220620/mechanisms/cal12_ms.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ical = pbar * m * ( h * a + 1.0 - a ) * ghk ( _threadargscomma_ v , cali , calo ) * modulationDA ( _threadargs_ ) * modulationACh ( _threadargs_ ) ;
   }
 _current += ical;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/HDD-drive/Repos/Alex_model_repo/models/optim/HBP-2022Q2/str-dspn-e150602_c1_D1-mWT-0728MSN01-v20220620/mechanisms/cal12_ms.mod";
static const char* nmodl_file_text = 
