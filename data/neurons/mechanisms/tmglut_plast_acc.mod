...
: https://link.springer.com/article/10.1186/1756-6606-6-5
: pSubstrate --> reduced failure rate, increased AMPA component
...
ENDVERBATIM
    ...
    if( urand() > failRate*modulation_factor_fail) {
...
COMMENT
(2026-05-22) Adding pSubstrate modulation, in addition to DA modulation
