...
from input_tuning.utils.check_features_traces import load_voltage_data
from input_tuning.utils.input_config import *
import json
import numpy as np
from snudda.utils import SnuddaLoad
from input_tuning.input_tuning_analysis import post_analysis
from input_tuning.utils.number_input import *
from input_tuning.utils.add_feature import *
from modify.count_passing import *
...
parser.add_argument("--singleNeuronType", default=None, type=str,
                    help="We want to simulate one neuron subtype, eg. FS_1")
...
add_input_feature_to_meta(args.networkName, args.input_type, neuron_path, ratio=0.5)
